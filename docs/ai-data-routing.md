...
| vnpy-trading | check_risk_gate ✅、compute_position_size ✅、propose_trading_plan ✅、get_trade_journal ✅、get_journal_report ✅、build_journal_prompt ✅、get_trading_discipline_context ✅ |
