...
| 交易流水 | `get_trade_journal` ✅ | `trade_journal` 结构化流水 |
| 纪律上下文 | `get_trading_discipline_context` ✅ | 计划摘要 + 流水违规 + 扛单 |
...
| 短线观察组有哪些 | `get_short_term_watchlist` | vnpy-watchlist | **已有** |
| 帮我做次日计划 | `propose_trading_plan` | vnpy-trading | **已有** |
| 复盘今天交易 | `get_trade_journal` / `build_journal_prompt` | vnpy-trading | **已有** |
| 还能不能开仓 | `check_risk_gate` | vnpy-trading | **已有** |
...
| vnpy-analysis | explain_screening_run, get_screening_context, technical_snapshot, list_strategy_signals, historical_pattern_summary, trend_scenario_summary, evaluate_entry_mode, assess_regulatory_deviation |
...
| vnpy-trading | check_risk_gate ✅、compute_position_size ✅、propose_trading_plan ✅、get_trade_journal ✅、get_journal_report ✅、build_journal_prompt ✅、get_trading_discipline_context ✅、evaluate_overnight_exit ✅ |
| vnpy-screening | … + `run_leader_screen` ✅ |
