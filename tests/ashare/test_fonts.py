...
from vnpy_ashare.ui.shell import fonts


class FontSelectionTest(unittest.TestCase):
    @patch("vnpy_ashare.ui.shell.fonts.platform.system", return_value="Darwin")
    ...
    @patch("vnpy_ashare.ui.shell.fonts.platform.system", return_value="Windows")
    ...
    @patch("vnpy_ashare.ui.shell.fonts.available_font_families", return_value=("PingFang SC", "Arial"))
    ...
    @patch("vnpy_ashare.ui.shell.fonts.available_font_families", return_value=("PingFang SC",))
