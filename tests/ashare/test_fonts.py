...
from vnpy_ashare.ui import fonts


class FontSelectionTest(unittest.TestCase):
    @patch("vnpy_ashare.ui.fonts.platform.system", return_value="Darwin")
    ...
    @patch("vnpy_ashare.ui.fonts.platform.system", return_value="Windows")
    ...
    @patch("vnpy_ashare.ui.fonts.available_font_families", return_value=("PingFang SC", "Arial"))
    ...
    @patch("vnpy_ashare.ui.fonts.available_font_families", return_value=("PingFang SC",))
