...
def collect_busy_widgets(page: QuotesPage, *, lock_table: bool = True) -> list[QtWidgets.QWidget]:
    widgets: list[QtWidgets.QWidget] = [page.search_edit]
...
def set_busy(page: QuotesPage, busy: bool, *, lock_table: bool = True) -> None:
    ...
    if page.config.use_market_rank and not page.config.market_full_list:
...
def begin_cancellable_task(
    ...
    *,
    ...
    set_busy(page, True, lock_table=lock_table)
    ...
    page._task_guard.begin(
        message,
        widgets=collect_busy_widgets(page, lock_table=lock_table),
        primary=primary,
...
def end_cancellable_task(page: QuotesPage) -> bool:
    ...
    set_busy(page, False, lock_table=page._task_lock_table)
