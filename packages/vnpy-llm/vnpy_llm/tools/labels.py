...
_TOOL_LABELS: dict[str, str] = {
    ...
    "get_radar_snapshot": "读取雷达快照",
    "get_leader_pick_snapshot": "读取龙头卡",
    "run_leader_screen": "雷达龙头选股",
    "run_short_term_screen": "极致短线编排",
